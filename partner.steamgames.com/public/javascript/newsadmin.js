    ...
    if (itemid) {
        ...
        new Ajax.Request('https://partner.steamgames.com/admin/store/getitemdisplaydetailsjson/', {
            ...
            onSuccess: function(transport) {
                ...
                removeLink.appendChild(new Element('img', {
                    src: g_szBaseUrl + '/public/images/marketing_tb_delete.gif'
                }));
                div.appendChild(removeLink);

                var span = new Element('span', {
                    'class': details['cssClass']
                });
...
function DisplayAssetHTML(assetFilename) {
    ...
    var width = 0,
        height = 0;
    if (g_strAssetType == 'header_image') {
        width = 460;
        height = 215;
    } else if (g_strAssetType == 'small_capsule') {
        width = 231;
        height = 87;
    } else if (g_strAssetType == 'large_capsule') {
        width = 467;
        height = 181;
    } else if (g_strAssetType == 'main_capsule') {
        width = 616;
        height = 353;
    }
